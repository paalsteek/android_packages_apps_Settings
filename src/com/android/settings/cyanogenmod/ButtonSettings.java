...
public class ButtonSettings extends SettingsPreferenceFragment implements
    ...
    // Engle, 添加相机键唤醒
    private CheckBoxPreference mFocusWake;
    private static final String KEY_FOCUS_WAKE = "pref_focus_wake";
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        // Engle, 添加相机键唤醒
        mFocusWake = (CheckBoxPreference) findPreference(KEY_FOCUS_WAKE);
        if (mFocusWake != null) {
            mFocusWake.setChecked(Settings.System.getInt(resolver,
                    Settings.System.FOCUS_WAKE_SCREEN, 0) == 1);
        }
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mHomeLongPressAction) {
            ...
            return true;
        } else if (preference == mFocusWake) {// Engle, 添加相机键唤醒
            Settings.System.putInt(getContentResolver(), Settings.System.FOCUS_WAKE_SCREEN,
                    mFocusWake.isChecked() ? 1 : 0);
